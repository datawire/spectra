...
var JSONSchemaFaker = (() => {
      ...
      for (const sub of dep.values) {
        if (utils_default.hasValue(sub.properties[dep.prop], result.value[dep.prop])) {
          Object.keys(sub.properties).forEach((next) => {
            if (next !== dep.prop) {
              utils_default.merge(result.value, traverseCallback.properties(sub.properties, path.concat(["properties"]), resolve, value).value);
            }
          });
          break;
        }
  ...
  function createTraverse(ticks) {
    function traverse(schema, path, resolve, rootSchema) {
        ...
        if (!types_default[type]) {
          if (option_default("failOnInvalidTypes")) {
            ...
            if (typeof value === "string" && types_default[value]) {
              return { value: types_default[value](schema, path, resolve, traverse), context };
            }
            return { value, context };
          }
        } else {
          try {
            const innerResult = types_default[type](schema, path, resolve, traverse);
            if (type === "array") {
              return {
      ...
      return { value: toMaybeDraft4_default(schema), context };
    }
    traverse.properties = (object, path, resolve) => {
      ...
      Object.keys(object).forEach((prop) => {
        ...
        if (typeof object[prop] === "object" && prop !== "definitions") {
          ...
          valueCopy[prop] = utils_default.clean(value, object[prop], false);
  ...
  function run(refs, schema, container2, synchronous) {
    ...
    const ticks = (_a = option_default("ticks")) != null ? _a : -1;
    const traverse = traverse_default(ticks);
    try {
      ...
      return traverse(utils_default.clone(schema), [], resolveSchema);
    } catch (e) {
      if (e.path) {
...
${pair.comment}` : item.comment;
      ...
      KNOWN_VOCABULARY = /* @__PURE__ */ new Set([
        "$ref",
        "id",
        "$schema",
        "title",
      ...
      toMaybeDraft4_default = toMaybeDraft4;
  ...
  var require_main_iife = __commonJS({
    "src/src/main.iife.js"(exports, module) {
      ...
      if (typeof $RefParser !== "undefined") {
        jsf2.setDependencies({ $RefParser });
      }
