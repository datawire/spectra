...
// src/lib/core/toMaybeDraft4.mjs
...
var KNOWN_VOCABULARY, toMaybeDraft4_default;
var init_toMaybeDraft4 = __esm({
  "src/lib/core/toMaybeDraft4.mjs"() {
...
var import_json_schema_ref_parser;
var init_main = __esm({
  "src/lib/main.mjs"() {
    import_json_schema_ref_parser = __toESM(require("json-schema-ref-parser"), 1);
    init_vendor();
    init_lib();
    setDependencies({ $RefParser: import_json_schema_ref_parser.default });
  }
});
